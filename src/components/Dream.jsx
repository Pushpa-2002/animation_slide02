  ...
  return (
    <div ref={ref} id='dream' className="relative w-full h-[100vh] bg-gradient-to-br from-yellow-300 to-purple-500 text-white flex flex-col space-y-10 p-10 justify-center items-center overflow-hidden">
      ...
      <div className="z-10 text-center">
        <h2 className={`text-8xl font-bold ${isInView ? 'animate-from-bottom' : 'opacity-0'}`}>DREAM</h2>
        <p className={`text-xl font-medium ${isInView ? 'animate-from-bottom' : 'opacity-0'}`}>Every journey begins with a vision of a better future</p>
        <ul className={`mt-8 border-[10px] rounded-xl p-4 w-[400px] bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 flex flex-col items-center justify-center text-black border-black
         ${
            isInView ? 'animate-scale-in , animate-from-bottom'  : 'opacity-0'
          }`}>
